    ...
    return `<div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            ...
            <div class="flex flex-wrap gap-2 pt-4 border-t border-gray-100 dark:border-gray-700">
                ...
                <button onclick="document.getElementById('job-tasks-section')?.scrollIntoView({behavior:'smooth', block:'start'})" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg transition-colors" style="transition: box-shadow 0.2s ease, border-color 0.2s ease;" onmouseenter="this.style.boxShadow='0 0 10px rgba(45,212,191,0.5)';this.style.borderColor='#2dd4bf'" onmouseleave="this.style.boxShadow='none';this.style.borderColor=''">Tasks${totalTasks > 0 ? ` (${completedCount}/${totalTasks})` : ''}</button>
                <button onclick="document.getElementById('job-dailylog-section')?.scrollIntoView({behavior:'smooth', block:'start'})" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg transition-colors" style="transition: box-shadow 0.2s ease, border-color 0.2s ease;" onmouseenter="this.style.boxShadow='0 0 10px rgba(45,212,191,0.5)';this.style.borderColor='#2dd4bf'" onmouseleave="this.style.boxShadow='none';this.style.borderColor=''">Daily Log${jobLogs.length > 0 ? ` (${jobLogs.length})` : ''}</button>
