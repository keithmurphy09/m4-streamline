...
function addFooter() {
  ...
  footer.innerHTML = '<div class="tn-footer-inner">' +
    ...
    '<img class="tn-footer-txt" src="tradies-network-text.png" alt="Tradies Network">' +
    '<div class="tn-footer-sub" style="font-size:11px;color:#2dd4bf">Powered by M4 STREAMLINE</div>' +
