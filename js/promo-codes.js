...
window.renderPromoAdmin = async function(container) {
  try {
    ...
    h += '<select id="pc-new-applies" style="min-width:110px;margin-right:8px"><option value="subscription">Subscription</option><option value="advertising">Advertising</option><option value="both">Both</option></select>';
