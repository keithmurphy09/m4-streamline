...
window.downloadUserGuide = function(){ window.open('https://docs.google.com/viewer?url=https://www.m4streamline.com/docs/Streamline_User_Guide.pdf&embedded=true', '_blank'); };
