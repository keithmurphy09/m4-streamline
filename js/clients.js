            ...
            return `<div${letterAnchor} class="bg-white dark:bg-gray-800 px-4 py-3 rounded-lg shadow ${isSelected ? 'ring-2 ring-blue-400' : ''}">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex gap-2 flex-shrink-0">
                        <button onclick="openClientQuickView('${c.id}')" class="px-3 py-1.5 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600 rounded text-sm whitespace-nowrap" style="transition: all 0.2s ease;" onmouseenter="this.style.backgroundColor='#2dd4bf';this.style.borderColor='#2dd4bf';this.style.color='#ffffff'" onmouseleave="this.style.backgroundColor='';this.style.borderColor='';this.style.color=''">View</button>
                        <button onclick='openQuoteForClient(${JSON.stringify(c).replace(/"/g, "&quot;")})' class="px-3 py-1.5 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600 rounded text-sm whitespace-nowrap" style="transition: all 0.2s ease;" onmouseenter="this.style.backgroundColor='#2dd4bf';this.style.borderColor='#2dd4bf';this.style.color='#ffffff'" onmouseleave="this.style.backgroundColor='';this.style.borderColor='';this.style.color=''">New Quote</button>
                        <button onclick='openModal("client", ${JSON.stringify(c).replace(/"/g, "&quot;")})' class="px-3 py-1.5 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600 rounded text-sm whitespace-nowrap" style="transition: all 0.2s ease;" onmouseenter="this.style.backgroundColor='#2dd4bf';this.style.borderColor='#2dd4bf';this.style.color='#ffffff'" onmouseleave="this.style.backgroundColor='';this.style.borderColor='';this.style.color=''">Edit</button>
                        <button onclick="deleteClient('${c.id}')" class="px-3 py-1.5 text-red-600 border border-red-200 dark:border-red-800 rounded text-sm whitespace-nowrap" style="transition: all 0.2s ease;" onmouseenter="this.style.backgroundColor='#ef4444';this.style.borderColor='#ef4444';this.style.color='#ffffff'" onmouseleave="this.style.backgroundColor='';this.style.borderColor='';this.style.color=''">Delete</button>
                    </div>
                </div>
            </div>`;
        }).join('');
