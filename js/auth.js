...
const STRIPE_PRICES = {
    sole_trader: 'price_1T3y5pRyQRluLLu54EqUiRky',  // $79/month
    business: 'price_1T3y6NRyQRluLLu5b4DycH9p'      // $149/month
};
...
async function loadAllData() {
    ...
    try {
        ...
        if (!subscription && !isTeamMember) {
            ...
            const monthlyRate = accountType === 'business' ? 149 : 79;
