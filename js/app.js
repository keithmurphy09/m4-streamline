                    ...
                    <div class="flex items-center justify-center md:justify-end gap-3 md:gap-4">
                        ...
                        ${isAdmin ? `
                            <div class="flex gap-2">
                                <button onclick="enterDemoMode('sole_trader');" class="no-glow px-3 py-2 bg-white hover:bg-teal-50 rounded-lg text-sm border border-teal-400">
                                    Sole Trader
                                </button>
                                <button onclick="enterDemoMode('business');" class="no-glow px-3 py-2 bg-white hover:bg-teal-50 rounded-lg text-sm border border-teal-400">
                                    Business
                                </button>
                                <button onclick="exitDemoMode();" class="no-glow px-3 py-2 bg-white hover:bg-teal-50 rounded-lg text-sm border border-teal-400">
                                    Real
                                </button>
                            </div>
                        ` : ''}
                        
                        <button onclick="toggleDarkMode()" class="no-glow px-3 py-2 bg-white hover:bg-teal-50 rounded-lg text-sm border border-teal-400">
                            ${darkMode ? '☀️' : '🌙'}
                        </button>
                        
                        <div class="relative">
                            <button onclick="toggleSettingsMenu()" class="no-glow px-3 py-2 bg-white hover:bg-teal-50 rounded-lg text-sm border border-teal-400 flex items-center gap-2">
