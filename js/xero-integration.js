...
function inject() {
  ...
  if (window._xStatus && window._xStatus.connected) {
    ...
    h += '<div class="xero-sync-row"><div><div style="font-size:14px;font-weight:500;color:#374151;" class="dark:text-gray-200">Payroll Hours</div><div style="font-size:11px;color:#94a3b8;">Push team clock-in hours to Xero for payroll</div></div><button class="xero-sync-btn" id="xero-sync-time" onclick="xeroSyncTimesheets()">Sync Now</button></div>';
